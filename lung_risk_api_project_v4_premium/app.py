...
VARIABLE_DESCRIPTIONS = {
    "Smoking": "Evalúa el nivel de exposición al tabaco, ya sea por consumo directo o exposición frecuente al humo.",
    "Air Pollution": "Representa la exposición habitual a contaminantes del aire como humo, polvo, tráfico intenso o combustión.",
    "Alcohol use": "Describe la frecuencia o intensidad aproximada del consumo de alcohol reportada por el usuario.",
    "Obesity": "Indica el grado de exceso de peso. Puede apoyarse en el cálculo del IMC como referencia orientativa.",
    "Genetic Risk": "Considera antecedentes familiares o predisposición genética relacionada con cáncer de pulmón u otras neoplasias.",
}
